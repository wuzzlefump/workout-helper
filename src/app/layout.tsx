...
export const metadata: Metadata = {
  ...
  appleWebApp: {
    capable: true,
    statusBarStyle: "black-translucent", // Makes the app go behind the status bar
    title: "Workout Helper",
    startupImage: [
      {
        url: "../../public/splash/apple-splash-2048-2732.jpg",
        media:
          "(device-width: 1024px) and (device-height: 1366px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)",
      },
      {
        url: "../../public/splash/apple-splash-2732-2048.jpg",
        media:
          "(device-width: 1024px) and (device-height: 1366px) and (-webkit-device-pixel-ratio: 2) and (orientation: landscape)",
      },
      {
        url: "../../public/splash/apple-splash-1668-2388.jpg",
        media:
          "(device-width: 834px) and (device-height: 1194px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)",
      },
      {
        url: "../../public/splash/apple-splash-2388-1668.jpg",
        media:
          "(device-width: 834px) and (device-height: 1194px) and (-webkit-device-pixel-ratio: 2) and (orientation: landscape)",
      },
      {
        url: "../../public/splash/apple-splash-1536-2048.jpg",
        media:
          "(device-width: 768px) and (device-height: 1024px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)",
      },
      {
        url: "../../public/splash/apple-splash-2048-1536.jpg",
        media:
          "(device-width: 768px) and (device-height: 1024px) and (-webkit-device-pixel-ratio: 2) and (orientation: landscape)",
      },
      {
        url: "../../public/splash/apple-splash-1640-2360.jpg",
        media:
  ...
  formatDetection: {
    telephone: false, // Prevents auto-linking phone numbers which can mess up UI
  },
};
export const viewport = {
  width: "device-width",
  initialScale: 1,
  viewportFit: "cover", // This is the magic line for iOS
};
  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        ...
        <div className="h-[100vh] pt-[env(safe-area-inset-top)]">
